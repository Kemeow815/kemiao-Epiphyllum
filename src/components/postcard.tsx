...
export function postMeta({
    ...
    return (
        <div className={`${className} font-semibold text-sm`}>
            ...
            <div className="meta-icon"><svg className="text-xl" data-icon="material-symbols:calendar-today-outline-rounded" height="1em" viewBox="0 0 24 24" width="1em"><symbol id="ai:material-symbols:calendar-today-outline-rounded"><path d="M5 22q-.825 0-1.412-.587T3 20V6q0-.825.588-1.412T5 4h1V3q0-.425.288-.712T7 2t.713.288T8 3v1h8V3q0-.425.288-.712T17 2t.713.288T18 3v1h1q.825 0 1.413.588T21 6v14q0 .825-.587 1.413T19 22zm0-2h14V10H5zM5 8h14V6H5zm0 0V6z" fill="currentColor"></path></symbol><use xlinkHref="#ai:material-symbols:calendar-today-outline-rounded"></use></svg></div>
                <span >
            ...
            <div className="flex items-center">
                <div className="meta-icon"><svg className="text-xl" data-icon="material-symbols:book-2-outline-rounded" height="1em" viewBox="0 0 24 24" width="1em"><symbol id="ai:material-symbols:book-2-outline-rounded"><path d="M6 15.325q.35-.175.725-.25T7.5 15H8V4h-.5q-.625 0-1.062.438T6 5.5zM10 15h8V4h-8zm-4 .325V4zM7.5 22q-1.45 0-2.475-1.025T4 18.5v-13q0-1.45 1.025-2.475T7.5 2H18q.825 0 1.413.587T20 4v12.525q0 .2-.162.363t-.588.362q-.35.175-.55.5t-.2.75t.2.763t.55.487t.55.413t.2.562v.25q0 .425-.288.725T19 22zm0-2h9.325q-.15-.35-.237-.712T16.5 18.5q0-.4.075-.775t.25-.725H7.5q-.65 0-1.075.438T6 18.5q0 .65.425 1.075T7.5 20" fill="currentColor"></path></symbol><use xlinkHref="#ai:material-symbols:book-2-outline-rounded"></use></svg></div>
            ...
            <div className="items-center flex">
                <div className="flex flex-row flex-nowrap items-center">
                    ...
                    {!(tags && tags.length > 0) && (
                        <div className="transition text-50">
                            noTags
                        </div>
                    )}
                </div>
